    ...
    def setUp(self):
        ...
        ella_fitzgerald, _ = Band.objects.get_or_create(
            ...
            description=(
                ...
                'was an American jazz singer often referred to as the '
                'First Lady of Song, Queen of Jazz and Lady Ella. She '
                'was noted for her purity of tone, impeccable diction, '
                'phrasing and intonation, and a horn-like improvisational '
        ...
        django_reinhardt, _ = Band.objects.get_or_create(
            ...
            description=(
                ...
                'was a Belgian-born, Romani French jazz guitarist and '
                'composer, regarded as one of the greatest musicians '
                'of the twentieth century. He was the first jazz talent '
                'to emerge from Europe and remains the most significant.'))
        louis_armstrong, _ = Band.objects.get_or_create(
            ...
            description=(
                ...
                'trumpeter, composer, singer and occasional actor who '
                'was one of the most influential figures in jazz. '
                'His career spanned five decades, from the 1920s to '
                'the 1960s, and different eras in the history of jazz.'))
        # Bands and Genres
